...
import com.nicholas.dbandeng.modul.ModulLogIOT
import com.nicholas.dbandeng.utils.SetDataChart
import com.nicholas.dbandeng.utils.SocketInstance
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        switchConveyor.setOnCheckedChangeListener { buttonView, isChecked ->
            if(!firstConnection){
                ...
                socketHandler.emit("add_device_log", "1;$idMitra")
            }
        }
    ...
    private val onNewMessagePerintah = Emitter.Listener { args ->
        runOnUiThread(kotlinx.coroutines.Runnable {
            ...
            if(data == "successon"){
                ...
                socketHandler.emit("add_device_log", "2;$idMitra")
